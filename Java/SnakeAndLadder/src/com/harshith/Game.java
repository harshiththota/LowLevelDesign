...
public class Game {
    ...
    private void initBoard() {
        ...
        for (int i = 0; i < numberOfSnakes; i++) {
            while (true) {
                int snakeStart = (int)(board.getStart() + Math.random() * board.getSize());
                int snakeEnd = (int)(board.getStart() + Math.random() * board.getSize());
        ...
        for (int i = 0; i < numberOfLadders; i++) {
            while (true) {
                int ladderStart = (int)(board.getStart() + Math.random() * board.getSize());
                int ladderEnd = (int)(board.getStart() + Math.random() * board.getSize());
